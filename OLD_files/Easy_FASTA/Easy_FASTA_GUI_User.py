...
def fasta_search():
    ...
    but_menu = ["Unused", ["Gene tag", "Locus tag", "Main tag", "Niben261", "Protein ID", "Protein name"]]
    ...
    while True:
        ...
        if event == "Run":
            ...
            prefix = ""
            if values["-SEARCH-"] == "Main tag" or values["-SEARCH-"] == "Niben261":
                prefix = ""
