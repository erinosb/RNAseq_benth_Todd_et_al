...
df = pd.read_excel("EggNog_v360_proteome_20230615_HopBA1_RNAseq_DEseq20230614.xlsx",
                   sheet_name = "Eggnog NbLAB360",
                   header=2,
                   usecols=["query", "GOs"])
...
df.to_excel("Extracted_EggNog_NbLAB360_IDs_GOs.xlsx")
...
with open("Nb_GO_Terms_EggNog_NbLAB360_HopBA1_RNAseq.txt", "w") as f:
...
for element in ID_GO_lst:
    with open("Nb_GO_Terms_EggNog_NbLAB360_HopBA1_RNAseq.txt","a") as f:
