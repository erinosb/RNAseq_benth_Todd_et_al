...
reslfc_HopBA1_v_EV <- lfcShrink(dds = dds, lfc = 1.0, coef="treatment_EV_vs_HopBA1", res = res_HopBA1_v_EV, svalue = FALSE)
help(lfcShrink)
summary(res_HopBA1_v_EV)
...
results_in_leaves <- results(CCdds, lfc = 1.0, contrast=c("combocond", "EV_L", "HopBA1_L"))
summary(results_in_leaves)
dim(results_in_leaves)

reslfc_in_leaves <- lfcShrink(dds = CCdds, lfc = 1.0, contrast=c("combocond", "EV_L", "HopBA1_L"), res = results_in_leaves, type="ashr")
summary(reslfc_in_leaves)

# SPLITCONDITIONS - and in petioles:
results_in_petioles <- results(CCdds, lfc = 1.0, contrast=c("combocond", "EV_P", "HopBA1_P"))
summary(results_in_petioles)

reslfc_in_petioles <- lfcShrink(dds = CCdds, lfc = 1.0, contrast=c("combocond", "EV_P", "HopBA1_P"), res = results_in_petioles, type="ashr")
...
results_in_leaves_2 <- results(CCdds, contrast=c("combocond", "HopBA1_L", "EV_L"), lfc =1)
summary(results_in_leaves_2)
# Get petiole-specific, HopBA1 v. EV differentially  expressed genes:
results_in_petioles_2 <- results(CCdds, contrast=c("combocond", "HopBA1_P", "EV_P"), lfc =1)
...
DOWN_in_HOPBA1_leaves <- DOWN_in_HOPBA1_leaves[order(DOWN_in_HOPBA1_leaves$log2FoldChange, decreasing = FALSE),]
dim(DOWN_in_HOPBA1_leaves)

UP_in_HOPBA1_leaves <- subset(sign_leaf, log2FoldChange > 1)
UP_in_HOPBA1_leaves <- UP_in_HOPBA1_leaves[order(UP_in_HOPBA1_leaves$log2FoldChange, decreasing = TRUE),]
...
DOWN_in_HOPBA1_petioles <- DOWN_in_HOPBA1_petioles[order(DOWN_in_HOPBA1_petioles$log2FoldChange, decreasing = FALSE),]
DOWN_in_HOPBA1_petioles
dim(DOWN_in_HOPBA1_petioles)


UP_in_HOPBA1_petioles <- subset(sign_petiole, log2FoldChange > 1)
UP_in_HOPBA1_petioles <- UP_in_HOPBA1_petioles[order(UP_in_HOPBA1_petioles$log2FoldChange, decreasing = TRUE),]
...
write.csv(UP_in_HOPBA1_leaves, file="../03_output/Up_HopBA1_Leaves_results.csv")
write.csv(UP_in_HOPBA1_petioles, file="../03_output/Up_HopBA1_Petioles_results.csv")
write.csv(DOWN_in_HOPBA1_leaves, file="../03_output/Down_HopBA1_Leaves_results.csv")
write.csv(DOWN_in_HOPBA1_petioles, file="../03_output/Down_HopBA1_Petioles_results.csv")

# Please cite R in your publications when using it
citation()

#MTN_temp: write data for all genes, no FC filter
write.csv (results_in_leaves_2, file = "../03_output/All_Leaf_results_noFCfilter.csv")
write.csv (results_in_petioles_2, file = "../03_output/All_Petiole_results_noFCfilter.csv")
write.csv (countsData, file = "../03_output/countsData.csv")
